                ...
                return (
                    <div
                        ...
                        <div>
                            ...
                            <h1>New state:</h1>
                            <div>Owner id: {this.props.logs[i].userId}</div>
                        ...
                        <div>
                            <h1>Old state:</h1>
                            <div>Owner id: {this.props.logs[i].userIdOld}</div>
                            <div>Collection name: {this.props.logs[i].collectionNameOld}</div>
                            <div>Collection description: {this.props.logs[i].collectionDescriptionOld}</div>
                            <div>Pictures details:
                                {Object.keys(this.props.logs[i].picturesArrayOld).map((j) => {
                                    return (
                                        <div key={j}>
                                            <div>Picture name: {this.props.logs[i].picturesArrayOld[j].pictureName}</div>
                                            <div>Picture description: {this.props.logs[i].picturesArrayOld[j].pictureDescription}</div>
                                            <div>Picture link: {this.props.logs[i].picturesArrayOld[j].pictureLink}</div>
                                        </div>
                                    )
                                })}
                            </div>
