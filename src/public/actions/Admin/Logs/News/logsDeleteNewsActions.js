...
export function onGetLogsInitiate() {
    return {type: types.ON_FETCH_LOGS_DELETE_NEWS_INITIATE}
}

// Successfully retrieved the logs
export function onGetLogsSuccess(logs) {
    return {type: types.ON_FETCH_LOGS_DELETE_NEWS_SUCCESS, logs: logs}
}

// Failed to retrieve the logs
export function onGetLogsFailure() {
    return {type: types.ON_FETCH_LOGS_DELETE_NEWS_FAILURE}
}
