...
export function onGetLogsInitiate() {
    return {type: types.ON_FETCH_LOGS_CREATE_COLLECTIONS_INITIATE}
}

// Successfully retrieved the logs
export function onGetLogsSuccess(logs) {
    return {type: types.ON_FETCH_LOGS_CREATE_COLLECTIONS_SUCCESS, logs: logs}
}

// Failed to retrieve the logs
export function onGetLogsFailure() {
    return {type: types.ON_FETCH_LOGS_CREATE_COLLECTIONS_FAILURE}
}
...
export function onGetLogs() {
    return function (dispatch) {
        ...
        return axios({
            method: 'get',
            url: '/admin/logsCollectionsCreate',
            headers: {
