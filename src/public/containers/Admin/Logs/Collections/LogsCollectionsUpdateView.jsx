...
import * as logsActions from '../../../../actions/Admin/Logs/Collections/logsUpdateCollectionsActions.js';
...
LogsCollectionsUpdateView.propTypes = {
...
const logs = (state) => {
    if (state.logsUpdateCollectionsReducer.fetching === true)
        return {
            fetchingLogs: true,
            fetchedLogs: false
        };
    else if (state.logsUpdateCollectionsReducer.fetched === true && state.logsUpdateCollectionsReducer.fetching === false)
        return {
            logs: state.logsUpdateCollectionsReducer.logs,
            fetchedLogs: true,
            fetchingLogs: false
        };
    else if (state.logsUpdateCollectionsReducer.fetched === false && state.logsUpdateCollectionsReducer.fetching === false)
        return {
            fetchedLogs: false,
            fetchingLogs: false
        };
...
export default connect(mapStateToProps)(LogsCollectionsUpdateView)